...
from services.gemeni_service import generate_thumbnail
...
STYLES = {
    ...
    "vibrant_energetic": (
        ...
        "gradients, dynamic angles, eye-catching pop-art style colors, and "
        "energetic composition. The person should have an excited or engaging "
        "expression."
    ),
}
